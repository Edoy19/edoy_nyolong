...
class C_Print_cn extends CI_Controller
{
    /// @see __construct() 
    ...
    public function index()
    {
        ...
        $this->load->view('Print/V_Print_cn', $data);
    }
    ...
    function ajax_getbyhdrid()
    {
        ...
        $data = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_cn')->row();
    ...
    function print_show()
    {
        ...
        $test = $data['tb_cn'] = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_cn')->row();
        // error_reporting(0);
    ...
    function print_report1()
    {
        ...
        $data['username'] = $this->session->userdata('username');
        $data['tb_cn'] = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_cn')->row();
