...
class M_Part_model extends CI_Model {
   ...
   {
      $this->db->select_max('id_material');     
      $this->db->like('id_material', $mdate);
   ...
   Public Function get_tb_part_model()
   {
    ...
    $Query = $DB2->query("SELECT * FROM materialperpartmodel ORDER BY part_name ASC");
    $data = $Query->result();
    $DB2->Close();
    return  $data;
   }
