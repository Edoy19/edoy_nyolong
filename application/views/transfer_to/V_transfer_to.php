  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transfer to Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="jpy" name="jpy" class="form-control" id="jpy" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_transfer_to/import'); ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_transfer_to/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_transfer_to/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_transfer_to/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_transfer_to/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_transfer_to/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
...
<script type="text/javascript">
  ...
  function handleSelectChange_tb_account_id(event) {

  var data = $('#tb_account_id').select2('data')[0].text;

  if (data=='-Select-'){
    $('#tb_account_name').val('');   
  }else{
    var res = data.split("-");
    $('#tb_account_name').val(res[1]);
  };
