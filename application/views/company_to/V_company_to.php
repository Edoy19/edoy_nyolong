    ...
    <section class="content-header">
      <div class="container-fluid"> <!-- container pada judul form-->
        <div class="row mb-2"> <!-- row pada halaman pada  ada judul form -->
          <div class="col-sm-6"> 
            <h1 class="m-0 text-dark">Company to Form</h1> <!-- judul form -->
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card"> <!-- .card -->
              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <th>ATTENTION</th>
                  <th>ATTENTION_DEPARTEMENT</th>
                  <th>EMAIL_AND_TELP</th>
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="company_to">COMPANY TO</label>
                    </div>
                    <div class="col-md-8">
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="company_address1">COMPANY ADDRESS1</label>
                    </div>
                    <div class="col-md-8">
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="company_address2">COMPANY_ADDRESS2</label>
                    </div>
                    <div class="col-md-8">
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="attention_departement">ATTENTION_DEPARTEMENT</label>
                    </div>
                    <div class="col-md-8">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_company_to/import'); ?>" enctype="multipart/form-data">  <!--fungsi import dari controller-->   
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_company_to/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                   ...
                   $('#company_to').val(data.company_to);
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_company_to/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_company_to/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_company_to/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_company_to/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
