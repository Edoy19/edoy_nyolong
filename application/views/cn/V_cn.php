        ...
        <div class="modal-dialog modal-lg" role="document" >
            ...
            <div class="form-group">
              ...
              <div class="form-group" clearfix>
                ...
                <div class="icheck-primary d-inline">
                    <input type="radio" id="payment_terms2" value="partial" name="payment_terms" onclick="Show_temporary()">
           ...
           <div class="card card-blue" id="card_cicilan">
              ...
              <div class="btn btn-success"  id="btn_add_row"  onclick="Add_cicilan_row()"> Tambah cicilan </div> 
                  <div class="card-body">
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
    ...
    // Hide button update director berdasarkan role
          ...
          if (status=="Add"){
            ...
            var no_cicilan=myArr[1];
                ...
                // Ajax isi data
                  ...
                  method: "get",
                  dataType : "JSON",              
                  data: {"hdrid":hdrid_cil,"no_cicilan":no_cicilan},
                  success: function (data) {
          ...
          function Simpan_data($trigger){
              ...
              //  Form data collect name value
                ...
                $('#quickForm input[type="file"]').each(function(i, e) {     
                    ...
                    if($trigger == 'Add') {       
                      ...
                      fdata.append("finish_settlement_cn_amount",$('#amount_total').val());
            ...
            function Delete_data(){
                ...
                function Delete_temporary(){
                  ...
                  // Url Post delete
                  vurl = "<?php echo base_url('c_cn/ajax_delete_temporary')?>";
         ...
         $(document).on("click", ".konfirmasiHapuscicilan", function() {
          ...
          <script type="text/javascript">
                  ...
                  {"data": 'hdrid',"sortable": false, //1
                      render: function (data, type, row, meta) {
                              ...
                              mnu='';
                                  ...
                                  <?php if($menu_name == 'Add Credit Note'){ 
            ...
            /// @attention jika diinput data yang sama akan muncul notif duplicate
             ...
             var vurl2; 
             vurl2 = "<?php echo base_url('c_cn/Ajax_Add_Row')?>";
          ...
          /// @see  Uppdate_cicilan
          /// @note untuk membuat trigger jika data cicilan sudah terupdate
          /// @attention data cicilan akan terupdate jika diinput
          ...
          var fdata = new FormData();
                  // if ($('#hdrid').val() == '') {
                  //   fdata.append('hdrid','<php echo $this->session->userdata('role_name')!='Administrator FA'; ?>');
                  // } else {
          fdata.append('hdrid',$('#hdrid').val());
                  // }
          ...
          // Url Post delete
          vurl = "<?php echo base_url('C_cn/ajax_update_director')?>";
          ...
          function Update_date(){
            ...
            // Url Post delete
            vurl = "<?php echo base_url('C_cn/ajax_update_date')?>";
