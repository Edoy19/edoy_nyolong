			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?php echo base_url('C_Dashboard') ?>">Home/</li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('C_role') ?>">Role Setting/</li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('C_user') ?>">User Setting/</li>
			...
			<!-- <?php foreach ($hasil as $value) {  ?>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-5">
                                  ...
                                  <div class="icheck-primary d-inline">
                                    <div class="col-md-12">
                                        <label> <?php if (strlen($value->menu_id) > 1) {
																									echo str_repeat('&nbsp;', 5);
																								} ?> </label>
                                        <input type="checkbox" name="menu_id[]" id="allow_add" >
                                        <label for="allow_add">
                                          <?php echo $value->menu_id . " - " . $value->menu_name;  ?>
                                        </label>
                                    </div>
                                  </div>
                          ...
                          <div class="col-md-1.5" <?php if (strlen($value->menu_id) == 1) {
																										echo "hidden";
																									} ?> >
                            <div class="icheck-primary d-inline">
                              <div class="col-md-12">
