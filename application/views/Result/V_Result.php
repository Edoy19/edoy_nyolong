			...
			<div class="row">
				<div class="col-12">
					...
					<div class="row mb-2">
						...
						<div class="col-md-3">
							<div class="form-group">
								<input type="date" id="search_fromdate" class="form-control " data-target="#startdate" />
							</div>
						</div>
		...
		<div class="modal-content">
					...
					<div class="row">
						<div class="col-md-6 order-md-1">
							...
							foreach ($approve as $ap) {
								if ($ap->status_sortir == 'active') { ?>
									<div class="table-responsive">
										<table class="table table-bordered table-hover nowrap table-striped" id="TableApproval" style="text-align:center">
											<thead>
												<tr>
													<th>Date</th>
													<th>Requested by</th>
						...
						<div class="col-md-6 order-md-2">
							<select class="form-control select5" id="request_sort" name="request_sort" onchange="handleSelectChange_reqsortir(event)" style="width: 100%;">
								<option value='' selected="selected">-Select Name-</option>
								<?php
								foreach ($superior as $value3) {
									echo "<option value='$value3->name_superior2'$value3->name_superior2</option>";
								}
								?>
							</select>
						</div>
				...
				<div class="card-body" style="overflow-x: unset;">
					...
					<div class="form-group">
						<div class="row" style="text-align: center;">
							...
							<div class="col-md-3">
								<input type="text" style="text-align: center;" name="part_name" class="form-control" id="part_name">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row" style="text-align: center;">
							...
							<div class="col-md-3">
								<label for="cust_name2" class="form-control" style="white-space: normal; word-wrap: break-word; text-overflow: ellipsis; max-width: 100%; overflow: auto;">ANOTHER
									CUSTOMER</label>
							</div>
							<div class="col-md-3">
						...
						<div class="row" style="text-align: center;">
							...
							<div class="col-sm-3">
								<div class="input-group date" data-date-format="YYYY-MM-DD" id="timepickerocc_date" data-target-input="nearest">
									<input type="date" id="occ_date" name="occ_date" class="form-control " data-target="#timepickerocc_date" />
			...
			<div class="card" id="detailResult">
				...
				<form role="form" id="formResult">
					<!-- <div class="card-body">
						<div class="form-group">
							<div class="card-header d-flex flex-row flex-nowrap overflow-auto" style="text-align: center;">
								...
								<div class="col-md-3">
									...
									<input type="date" id="ResultDate" name="ResultDate" class="form-control " data-target="#timepickerResultDate" />
								</div>
								<div class="col-md-3">
							...
							<br></br>
							<div class="col-md-12">
								<button type="button" class="btn btn-primary" onclick="Simpan_data_result('Add')" id="simpan_result">simpan</button>
							</div>
						</div>
					</div> -->
					...
					<div class="card-body">
						<div class="card-body">
							<div class="table-responsive" style="overflow-x:unset;">
								<table id="TableResult" class="table table-bordered table-hover display nowrap table-striped" style="text-align:center">
									<thead>
										<tr>
											<!-- <th>REPORT NO.</th> -->
											<th>ACTION</th>
									...
									<tfoot>
										<tr id="tfooter">
											<th colspan="8"><strong> TOTAL QTY OK</strong></th>
											<th colspan="4"><strong id="TotalQTY">
												</strong></th>
										</tr>
										<tr id="tfooter">
											<th colspan="8"><strong>TOTAL QTY NG</strong></th>
											<th colspan="4"><strong id="TotalNG">
												</strong></th>
										</tr>
										<tr id="tfooter">
											<th colspan="8"><strong>% NG</strong></th>
											<th colspan="4"><strong id="PercentNG">
												</strong></th>
										</tr>
									</tfoot>
								</table>
			...
			<div class="card-body">
				...
				<div class="row mb-3">
					<div class="col-md-3">
						<label for="sortirresultby" class="form-control" style="white-space: normal; word-wrap: break-word; text-overflow: ellipsis; max-width: 100%; overflow: auto;">Result
							Sortir Checked by</label>
					</div>
					<div class="col-md-3">
				...
				<div class="row mb-3">
					<div class="col-md-3">
						<label for="resultapprove" class="form-control" style="white-space: normal; word-wrap: break-word; text-overflow: ellipsis; max-width: 100%; overflow: auto;">Result
							Sortir Approved by</label>
					</div>
					<div class="col-md-3">
					...
					<div class="form-group">
						...
						<div class="card-header d-flex flex-row flex-nowrap overflow-auto">
							...
							<div class="col-md-3">
								...
								<select class="form-control select2" id="part_number3" name="part_number" onchange="handleSelectChange_part_number3(event)" style="width: 100%;">
									<option value='' selected="selected">-Select-</option>
									<?php
							...
							<div class="col-md-4">
								<label class="form-control" style="font-size:14px;">Tanggal Keberangkatan (Dari
									DMIA)</label>
								<input type="date" class="form-control" value="" id="tgl_berangkat_customer2" name="tgl_customer2">
							</div>
							<div class="col-md-4">
								<label class="form-control" style="font-size:14px;">Tanggal Kedatangan
									(Sampai di Customer)</label>
								<input type="date" class="form-control" value="" id="tgl_datang_customer2" name="tgl_customer2">
							</div>
							<div class="col-md-4">
								<label class="form-control" style="font-size:14px; max-width: 100%; overflow: auto; text-overflow: ellipsis; white-space: normal; word-wrap: break-word;">Apakah
									lot bermasalah
							...
							<div class="col-md-4">
								<label class="form-control" style="font-size:14px;">Tanggal Keberangkatan
									(Dari DMIA)</label>
								<input type="date" class="form-control" id="tgl_berangkat_yusen2" name="tgl_yusen2" value="">
							</div>
							<div class="col-md-4">
								<label class="form-control" style="font-size:14px;">Tanggal Kedatangan
									(Sampai di Customer)</label>
								<input type="date" class="form-control" id="tgl_datang_yusen2" name="tgl_yusen2" value="">
							</div>
							<div class="col-md-3">
					...
					<div class="form-group">
						<div class="card-header d-flex flex-row flex-nowrap overflow-auto">
							...
							<div class="col-md-3">
								...
								<input type="date" id="tgl_perubahan2" name="tgl_perubahan2" class="form-control " data-target="#timepickertgl_perubahan" />
							</div>
							<div class="col-md-3">
...
<!-- RESULT -->
<div class="modal fade" id="modal-result" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true" style="overflow-y:auto;">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
					...
					<div class="form-group">
						<div class="card-header d-flex flex-row flex-nowrap overflow-auto">
							...
							<div class="col-md-3">
								...
								<input type="date" id="ResultDate2" name="ResultDate2" class="form-control " data-target="#timepickerResultDate2" />
							</div>
							<div class="col-md-3">
						...
						<div class="card-footer">
							<button type="button" class="btn btn-primary" onclick="Ubah_data_result('Update')" id="update4">Update</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						</div>
					</div>
				</div>
...
<div class="modal fade" id="modal-delete4">
	<div class="modal-dialog">
		<div class="modal-content bg-danger">
			...
			<div class="modal-footer justify-content-between">
				<form action="#" method="post">
					<button type="button" id="delete" onclick="Delete_data_result()" class="btn btn-outline-light">Yes</button>
				</form>
				<button type="button" class="btn btn-outline-light" data-dismiss="modal">No</button>
			</div>
		</div>
...
<script type="text/javascript">
	...
	// tabel5 = $('#TableApproval').DataTable({
	// 	"responsive": false,
	// 	"serverSide": true,
	// 	"autowidth": false,
	// 	"scrollX": false,
	// 	"ajax": {
	// 		"url": "<?= base_url('C_Result/ajax_getbyhdrid_approval'); ?>",
	// 		"type": "GET",
	// 		"data": function(data) {
	// 			if ($('#hdrid').val() == '') {
	// 				data.hdrid = '<?php echo $this->session->userdata('user_name') ?>';
	...
	$(document).ready(function() {
		tabel4 = $('#TableResult').DataTable({
			...
			"footerCallback": function(row, data, start, end, display) {
				...
				var total_format = monTotal2.toLocaleString(undefined, {
					minimumFractionDigits: 2
				});
				$('#TotalNG').text(total_format);
				console.log(total_format);

				var prtotal = parseFloat(total_format.replace(/[,\s]/g, '')) / parseFloat(montotal1
					.replace(/[,\s]/g, '')) * 100;
				var percentNG = prtotal.toLocaleString(undefined, {
					minimumFractionDigits: 2
				});
				$('#Percent').text(percentNG + "%");
				console.log(percentNG);
...
<script type="text/javascript">
	...
	function handleSelectChange_reqsortir(event) {
