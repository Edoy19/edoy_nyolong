                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="card-header d-flex flex-row flex-nowrap overflow-auto">
							...
							?>
                            <div class="col-md-3">
                                <label for="check_spv2" class="form-control">CHECK SPV</label>
                                <input type="text" name="check_spv2" class="form-control" id="check_spv2"
                                    value="<?php if($this->session->userdata('rolename')=='SUPERVISOR') { echo $this->session->userdata('nama'); }?>"
                                    disabled>
                            </div>
                            <div class="col-md-3">
                                <label for="check_mgr" class="form-control">CHECK MGR</label>
...
$(document).ready(function() {
    $('#modal-perubahan').on('show.bs.modal', function() {
        var checkSpvValue = $('#check_spv').val();
        $('#check_spv').val(checkSpvValue);
    });
});
</script>
