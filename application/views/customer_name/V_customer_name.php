...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Customer Form</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="custno" class="form-control" id="custno"
                                ...
                                <select class="form-control select2" id="cust_name" name='cust_name'
                                    ...
                                    <?php
                                                  foreach ($customer as $value) {
                                                    echo "<option value='$value->cust_name'>$value->cust_name-$value->cust_keterangan</option>";                                                 
                                                                           }
                                          ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="cust_keterangan">CUSTOMER KETERANGAN</label>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" name="cust_keterangan" class="form-control" id="cust_keterangan">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="<?php echo base_url('c_customer_name/import'); ?>"
...
$(document).ready(function() {
    ...
    $('#quickForm').validate({
        ...
        messages: {
            ...
            cust_keterangan: {
                required: "Please Input Customer Keterangan",
                minlength: 3
            },
...
function view_modal(custno1, status) {
    ...
    if (status == "Add") {
        ...
        // Ajax isi data
        $.ajax({
            url: "<?php echo base_url('C_Customer_Name/ajax_getbycustno')?>",
            method: "get",
            dataType: "JSON",
            data: {
                custno: custno1
            ...
            success: function(data) {
                ...
                $('#cust_keterangan').val(data.cust_keterangan);
...
function Simpan_data($trigger) {
    ...
    var vurl;
    if ($trigger == 'Add') {
        vurl = "<?php echo base_url('C_customer_name/ajax_add')?>";
    } else {
        vurl = "<?php echo base_url('C_customer_name/ajax_update')?>";
    }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#cust_name').select2().val('0').trigger('change');
...
function Delete_data() {
    ...
    // Delete by custno
    fdata.append('custno', $('#iddelete').text());
    // Url Post delete
    vurl = "<?php echo base_url('C_customer_name/ajax_delete')?>";
...
$(document).ready(function() {
    ...
    tabel = $('#example1').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url('C_customer_name/view_data_where');?>", // URL file untuk proses select datanya
            "type": "POST",
            "data": function(data) {
